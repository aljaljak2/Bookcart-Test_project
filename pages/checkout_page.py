...
class CheckoutPage(BasePage):
    ...
    # Locators
    _NAME_INPUT = (By.CSS_SELECTOR, "input[formcontrolname='name'][data-placeholder='Name']")
    _ADDRESS_LINE1_INPUT = (By.CSS_SELECTOR, "input[formcontrolname='addressLine1']")
    _ADDRESS_LINE2_INPUT = (By.CSS_SELECTOR, "input[formcontrolname='addressLine2']")
    _PINCODE_INPUT = (By.CSS_SELECTOR, "input[formcontrolname='pincode']")
    _STATE_INPUT = (By.CSS_SELECTOR, "input[formcontrolname='state']")
